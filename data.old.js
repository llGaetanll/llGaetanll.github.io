const overview = {
  ...
  Education: [
    ...
    },
    {
      ...
      desc: "2013 - 2014",
      about: `This is where I learned to solve a rubik's cube for the first time. It's also where I was introduced to the idea of programming.`
    },
    {
      title: "Mougins School",
  ...
  Outreach: [
    ...
    },
    {
      ...
      subtitle: "Helping children in developing areas",
      desc: "GRADE 10 - GRADE 12",
      about: `Breakthrough Miami is a club in which we teach middle schoolers STEM related topics such as computer science, engineering and biomedical.`
    }
  ],
  Projects: [
    {
      ...
      links: [
        {
          name: "GitHub",
          url:
            "https://github.com/Mobility-Based-Infrastructure-Using-ML/MobiusML"
        },
        {
          name: "YouTube",
    ...
    },
    {
      ...
      links: [
        {
          name: "GitHub",
          url: "https://github.com/llGaetanll/Chroma-Tilt"
        },
        {
          name: "TV",
          url: "https://www.youtube.com/watch?v=679i0RwXcFg"
        },
        {
          name: "Play Store",
          url:
            "https://play.google.com/store/apps/details?id=com.almela.gaetan.chromatilt"
        }
      ],
      about: [
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          name: "Plat Store",
          url:
            "https://play.google.com/store/apps/details?id=com.almela.gaetan.timer"
        }
      ],
  ...
  Awards: [
    ...
    `Winner of the 2017 *[Congressional App Challenge] for ChromaTilt`
  ],
  Languages: [
